...
goal_digits = set([1, 4, 7, 8])
all_digits = chain.from_iterable(outputs)

matching_digits = (digit for digit in all_digits if digit in goal_digits)

matching_count = sum(1 for _ in matching_digits)
